...
// "@libsql/client/web", not "@libsql/client". The default entrypoint reaches
// for node:net to open a TCP connection to libsql; a Worker has no sockets and
// the import fails at build time. The /web entrypoint speaks the same API over
// HTTP. This is the ONLY line changed in any file copied from the Vercel app.
